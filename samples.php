...
/**
 * Example 2: Usage of 'ip-location-block-ip-addr'
...
add_filter( 'ip-location-block-ip-addr', 'my_retrieve_ip' );
...
add_filter( 'ip-location-block-login', 'my_emergency' );
add_filter( 'ip-location-block-admin', 'my_emergency' );


/**
 * Example 4: Usage of 'ip-location-block-comment'
...
add_filter( 'ip-location-block-comment', 'my_blacklist' );


/**
 * Example 5: Usage of 'ip-location-block-login' and 'ip-location-block-xmlrpc'
...
add_filter( 'ip-location-block-xmlrpc', 'my_whitelist' );
...
if ( defined( 'DOING_AJAX' ) && DOING_AJAX )
	add_filter( 'ip-location-block-admin', 'my_permitted_ajax' );
...
/**
 * Example 8: Usage of `ip-location-block-xxxxxx-(status|reason)`
...
/**
 * Example 10: Usage of 'ip-location-block-bypass-plugins'
...
/**
 * Example 11: Usage of 'ip-location-block-bypass-themes'
...
/**
 * Example 12: Usage of 'ip-location-block-headers'
...
add_filter( 'ip-location-block-headers', 'my_user_agent' );


/**
 * Example 13: Usage of 'ip-location-block-maxmind-dir'
...
/**
 * Example 14: Usage of 'ip-location-block-maxmind-zip-ipv[46]'
...
/**
 * Example 15: Usage of 'ip-location-block-ip2location-path'
...
/**
 * Example 17: Usage of 'IP_Location_Block::get_geolocation()'
...
function my_geolocation() {
	 ...
	 */
	$geolocation = IP_Location_Block::get_geolocation();
...
/**
 * Example 18: Usage of 'ip-location-block-record-logs'
